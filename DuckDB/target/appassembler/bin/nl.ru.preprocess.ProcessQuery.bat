...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="nl.ru.preprocess.ProcessQuery" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" nl.ru.preprocess.ProcessQuery %CMD_LINE_ARGS%
